		...
		<fieldset class="scheduler-border">
			<legend class="scheduler-border">条件设置</legend>
                <form class="form1 form-inline">
					 ...
					 <div class="form-group">
						   <label>数据表名称</label>					
                           <input type="text" class="DataTableInput form-control" id="tablename" style="width:340px">               
					 </div>    
				      <div class="form-group">
	  ...
	  <table id="example" style="text-align:center;" class="display" cellspacing="0" >
	        <thead>
	            <tr>	 
	            	...
	            	<th style="width:10%;text-align:center;"  dataField=TABLENAME>数据表名称</th>
...
var example;
	$(document).ready(function() {
		...
		initMyDataTable('example', 'getMonItorDB', config,customConfig);	
