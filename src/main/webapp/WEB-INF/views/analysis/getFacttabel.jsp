...
<div class="panel panel-success" style="padding:0px;border:0px;border-bottom:0px;margin: 10px;">
	  ...
	  <table id="example" style="text-align:center;" class="display" cellspacing="0" >
	        <thead>
	            <tr>	 
	            	<th style="width:5%;text-align:center;"  dataField=FACTNAME>事实表名称</th>		
	            	<th style="width:5%;text-align:center;"  dataField=TABLENAME>事实表</th>		
...
<script type="text/javascript">
	...
	$(document).ready(function() {
	        ...
	        "columnDefs" : [ 	
   				  {
   					  	"render" : function(data, type, row, meta){
   					  		data = data + "," + row['FID'] ;
   					  		return getDelete(meta, data, "deleteFacttabel");
   					  	},
   					  	"targets" : [2]
   				  },
 	  			  {
		...
		initMyDataTable('example', 'getFacttabel_Result', config,customConfig);	
