...
<body>
                ...
                <form class="form1 form-inline">
					 <div class="form-group">
                           ...
                           <div class="input-group input-append date form_datetime">
						      <input type="text" class="DataTableInput form-control" size="16" readonly id="beginDateStart" value=""/>
						      <div class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></div>
						      <input type="text" class="DataTableInput form-control" size="16" readonly id="beginDateOver" value=""/>
						      <div class="input-group-addon" ><i class="glyphicon glyphicon-calendar"></i></div>
						   </div>          
					 </div>  					  
					 <div class="form-group">
						<label>结束时间</label>					
						 <div class="input-group input-append date form_datetime">
						      <input type="text" class="DataTableInput form-control" size="16" readonly id="endDateStart" value=""/>
						      <div class="input-group-addon" ><i class="glyphicon glyphicon-calendar"></i></div>
						      <input type="text" class="DataTableInput form-control" size="16" readonly id="endDateOver" value=""/>
						      <div class="input-group-addon" ><i class="glyphicon glyphicon-calendar"></i></div>
						 </div>
					  </div>
				      <div class="form-group">
	...
	$(".form-control").datetimepicker({ 
	  ...
	  <table id="example" style="text-align:center;" class="display" cellspacing="0" >
	        <thead>
	            <tr>	 
	            	<th style="width:10%;text-align:center;"  dataField=FILENAME>文件实例</th>		
	            	<th style="width:10%;text-align:center;"  dataField=STARTTIME>开始时间</th>		
	            	<th style="width:10%;text-align:center;"  dataField=ENDTIME>结束时间</th>	
	            	<th style="width:10%;text-align:center;"  dataField=STATE>当前状态</th>
	            	<th style="width:10%;text-align:center;"  dataField=UPDATETIME>更新时间</th>
	            	<th style="width:10%;text-align:center;"  dataField=OPEN >详细数据</th> 
	            </tr>
	        </thead>
	</table>
</div>
...
var example;
	$(document).ready(function() {
	        ...
	        "columnDefs" : [ 	
	                    
	          			  {
	        				  	"render" : function(data, type, row, meta){
	        				  		...
	        				  		return getDetail(meta, data, "getDetailInfo");
	        				  	},
	        				  	"targets" : [5]
	          			   }   
      			]
		...
		initMyDataTable('example', 'getRunInstance', config,customConfig);	
