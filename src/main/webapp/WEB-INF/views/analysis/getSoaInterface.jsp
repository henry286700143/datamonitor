...
<body>
			...
			<legend class="scheduler-border">条件设置</legend>
                <form class="form1 form-inline">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
						   <label>接口名称</label>					
                           <input type="text" class="DataTableInput form-control" id="functionname" style="width:340px">               
					 </div>  
				      <div class="form-group">
	...
	$(".form-control").datetimepicker({ 
	  ...
	  <table id="example" style="text-align:center;" class="display" cellspacing="0" >
	        <thead>
	            <tr>	 
	            	<th style="width:10%;text-align:center;"  dataField=FUNCTIONNAME>接口名称</th>		
	            	<th style="width:10%;text-align:center;"  dataField=NAME>配置名称</th>
...
var example;
	$(document).ready(function() {
		...
		initMyDataTable('example', 'getSoaInterface', config,customConfig);	
