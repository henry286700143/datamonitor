...
(function ($) {
    $.fn.bootstrapTree = function () {
    		...
    		if(treeObj instanceof Array){
    			...
    			for (var i = 0; i < treeObj.length; i++) {
    				...
    				if(typeof itemObj.html != 'undefined'){
    					itemLi.append("<span class='tool'><span class='treeBtn'></span> <span class='removeBtn glyphicon glyphicon-remove'></span> <span class='checkBtn glyphicon glyphicon-th-list'></span></span><span class='item'>"+itemObj.html+"</span>");
    				}
        ...
        function createTreeItem(html){
        	...
        	lastUl.append("<li></li>");
        	lastUl.find("li:last").append("<span class='tool'><span class='treeBtn'></span> <span class='removeBtn glyphicon glyphicon-remove'></span> <span class='checkBtn glyphicon glyphicon-th-list'></span></span><span class='item'>"+html+"</span>");
        	init();
        }
        ...
        function createNextItem(html){
        	...
        	lastLi.find("ul:first > li:last").append("<span class='tool'><span class='treeBtn'></span> <span class='removeBtn glyphicon glyphicon-remove'></span> <span class='checkBtn glyphicon glyphicon-th-list'></span></span><span class='item'>"+html+"</span>");
        	init();
        }
